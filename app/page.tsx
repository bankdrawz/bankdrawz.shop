    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative flex items-center justify-center h-screen overflow-hidden py-12">
        ...
        <div className="absolute inset-0 opacity-30">
          ...
          <div
            className="absolute bottom-1/3 right-1/3 w-96 h-96 bg-secondary/20 rounded-full filter blur-3xl animate-float"
            style={{ animationDelay: '1s' }}
          />
          <div
            className="absolute top-1/2 right-1/4 w-48 h-48 bg-accent/20 rounded-full filter blur-3xl animate-float"
        ...
        <div className="container px-4">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl">
              Check out some of my recent work. These projects showcase my skills in backend
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-muted-foreground mb-8">
                My tech stack includes JavaScript, TypeScript, Node.js, C++, SQL, and more. I love
                contributing to open-source projects and helping others in the developer community.
              </p>
              <Button asChild>
                <Link href="/about">
        ...
        <div className="container px-4">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
              I'm always open to new opportunities and exciting projects. Let's build something
              amazing together.
            </p>
