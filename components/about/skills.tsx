...
const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: 'HTML/CSS', level: 7, color: '#e34c26' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Express.js', level: 8, color: '#303030' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Vercel', level: 7, color: '#000000' },
  ...
  },
  {
    name: 'Databases',
    skills: [
      { name: 'MongoDB', level: 8, color: '#47a248' },
      { name: 'Mongoose', level: 8, color: '#800000' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'VS Code', level: 7, color: '#007acc' },
    ],
  },
  {
